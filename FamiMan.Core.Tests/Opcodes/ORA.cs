...
namespace FamiMan.Core.Tests.Opcodes
{
    ...
    public class ORATests
    {
        ...
        public void ORA_0x11_IndirectY()
        {
            _c.A = 5;
            byte i = 0;
            _b.Ram[i++] = ORA.IndirectIndexed.Opcode;
            ...
            Assert.Equal(5 | 14, _c.A);
            Assert.Equal(ORA.IndirectIndexed.Length, _c.PC);
        }
        ...
        public void ORA_0x01_IndirectX()
        {
            _c.A = 5;
            byte i = 0;
            _b.Ram[i++] = ORA.IndexedIndirect.Opcode;
            _b.Ram[i++] = 0xE8;                                 // Memory location: ZP 0x00E8/232d
            _c.X = 2;                                           // + 2 so 0x00EA
            ...
            Assert.Equal(5 | 14, _c.A);
            Assert.Equal(ORA.IndexedIndirect.Length, _c.PC);
        }
    }
}
