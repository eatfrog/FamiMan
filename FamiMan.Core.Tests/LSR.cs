...
namespace FamiMan.Core.Tests
{
    public class LSR
    {
        ...
        public void LSR_0x4E_Absolute()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.LSR.Absolute.Opcode;
            _b.Ram[i++] = 0x0E;
            _b.Ram[i++] = 0x00; // Memory location 0x000E = 14
            _b.Ram[0x0E] = 109; // 01101101
            _c.Tick(Opcodes.LSR.Absolute.Cycles);
        ...
        public void LSR_0x5E_Absolute_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.LSR.Absolute_X.Opcode;
            _b.Ram[i++] = 0x0E;
            _b.Ram[i++] = 0x00; // Memory location 0x000E = 14
            _c.X = 1;           // plus one is 15
            _b.Ram[0x0F] = 109; // 01101101
            _c.Tick(Opcodes.ASL.Absolute_X.Cycles);
        ...
        public void LSR_0x46_ZeroPage()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.LSR.ZeroPage.Opcode;
            _b.Ram[i++] = 0x0E; // Memory location 0x000E = 14
            _b.Ram[0x0E] = 109; // 01101101
            _c.Tick(Opcodes.LSR.ZeroPage.Cycles);
            ...
            _b.Ram[i++] = 0x0E; // Memory location 0x000E = 14
            _b.Ram[0x0E] = 128; // 10000000
            _c.Tick(Opcodes.ASL.ZeroPage.Cycles);
        ...
        public void LSR_0x56_ZeroPage_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.LSR.ZeroPage_X.Opcode;
            _b.Ram[i++] = 0x0E; // Memory location 0x000E = 14
            _c.X = 1;           // plux one = 15
            _b.Ram[0x0F] = 109; // 01101101
            _c.Tick(Opcodes.LSR.ZeroPage_X.Cycles);
        ...
        {
            byte i = 0;
            _b.Ram[i++] = Opcodes.LSR.Accumulator.Opcode;
            _c.A = 109;           // 01101101
            _c.Tick(Opcodes.LSR.Accumulator.Cycles);
