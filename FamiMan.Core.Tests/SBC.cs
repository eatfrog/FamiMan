...
namespace FamiMan.Core.Tests
{
    public class SBC
    {
        ...
        [Fact]
        public void SBC_0xE9_Immediate()
        {
            byte i = 0;
            _c.P.Carry = true;
        ...
        [Fact]
        public void SBC_0xF5_ZeroPage_X()
        {
            byte i = 0;
            _c.P.Carry = true;
        ...
        [Fact]
        public void SBC_0xFD_Absolute_X()
        {
            byte i = 0;
            _c.P.Carry = true;
        ...
        [Fact]
        public void SBC_0xF9_Absolute_Y()
        {
            byte i = 0;
            _c.P.Carry = true;
        ...
        [Fact]
        public void SBC_0xE1_IndirectX()
        {
            _c.A = 0xfd;
            _c.P.Carry = true;
            byte i = 0;
        ...
        [Fact]
        public void SBC_0xF1_IndirectY()
        {
            _c.A = 0xea;
            _c.P.Carry = true;
