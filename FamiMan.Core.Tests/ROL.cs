...
namespace FamiMan.Core.Tests
{
    public class ROL
    {
        ...
        public void ROL_0x2E_Absolute()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ROL.Absolute.Opcode;
            _b.Ram[i++] = 0x0E;
            _b.Ram[i++] = 0x00; // Memory location 0x000E = 14
            _b.Ram[0x0E] = 109; // 01101101
            _c.P.Carry = true;
            _c.Tick(Opcodes.ROL.Absolute.Cycles);
        ...
        public void ROL_0x3E_Absolute_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ROL.Absolute_X.Opcode;
            _b.Ram[i++] = 0x0E;
            _b.Ram[i++] = 0x00; // Memory location 0x000E = 14
            _c.X = 1;           // plus one is 15
            _b.Ram[0x0F] = 109; // 01101101
            _c.P.Carry = true;
            _c.Tick(Opcodes.ROL.Absolute_X.Cycles);
        ...
        public void ROL_0x26_ZeroPage()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ROL.ZeroPage.Opcode;
            _b.Ram[i++] = 0x0E; // Memory location 0x000E = 14
            _b.Ram[0x0E] = 109; // 01101101
            _c.P.Carry = true;
            _c.Tick(Opcodes.ROL.ZeroPage.Cycles);
        ...
        public void ROL_0x36_ZeroPage_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ROL.ZeroPage_X.Opcode;
            _b.Ram[i++] = 0x0E; // Memory location 0x000E = 14
            _c.X = 1;           // plux one = 15
            _b.Ram[0x0F] = 109; // 01101101
            _c.P.Carry = true;
            _c.Tick(Opcodes.ROL.ZeroPage_X.Cycles);
        ...
        {
            byte i = 0;
            _b.Ram[i++] = Opcodes.ROL.Accumulator.Opcode;
            _c.A = 109;           // 01101101
            _c.P.Carry = true;
            _c.Tick(Opcodes.ROL.Accumulator.Cycles);
