...
namespace FamiMan.Core.Tests
{
    ...
    public class ORA
    {
        ...
        public void ORA_0x09_Immediate()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ORA.Immediate.Opcode;    // ORA
            _b.Ram[i++] = 0x0E;                            // 14            

            _c.Tick(Opcodes.ORA.Immediate.Cycles);
        ...
        public void ORA_0x05_ZeroPage()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ORA.ZeroPage.Opcode;    // ORA
            _b.Ram[i++] = 0x0A;                           // Memory location 0x0A
            _b.Ram[0x0A] = 14;
            _c.Tick(Opcodes.ORA.ZeroPage.Cycles);
        ...
        public void ORA_0x15_ZeroPage_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ORA.ZeroPage_X.Opcode;    // ORA
            _b.Ram[i++] = 0x0A;                             // Memory location 0x0A
            _c.X = 2;
            _b.Ram[0x0C] = 14;
            _c.Tick(Opcodes.ORA.ZeroPage_X.Cycles);
        ...
        public void ORA_0x0D_Absolute()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ORA.Absolute.Opcode;    // ORA
            ...
            _b.Ram[0x03E8] = 14;
            _c.Tick(Opcodes.ORA.Absolute.Cycles);
        ...
        public void ORA_0x1D_Absolute_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ORA.Absolute_X.Opcode;    // ORA
        ...
        public void ORA_0x19_Absolute_Y()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ORA.Absolute_Y.Opcode;    // ORA
        ...
        public void ORA_0x11_IndirectY()
        {
            _c.A = 5;
            byte i = 0;
            _b.Ram[i++] = Opcodes.ORA.IndirectIndexed.Opcode;   // Add Indirect_X
            ...
            _c.Tick(Opcodes.ORA.IndirectIndexed.Cycles);        // Tick


            Assert.Equal(5 | 14, _c.A);
            Assert.Equal(Opcodes.ORA.IndirectIndexed.Length, _c.PC); // Program counter should have moved to correct value
        }
