...
namespace FamiMan.Core.Tests
{
    ...
    public class EOR
    {
        ...
        public void EOR_0x49_Immediate()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.EOR.Immediate.Opcode;    // EOR
            _b.Ram[i++] = 0x0E;                            // 14            

            _c.Tick(Opcodes.EOR.Immediate.Cycles);
        ...
        public void EOR_0x45_ZeroPage()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.EOR.ZeroPage.Opcode;    // EOR
            _b.Ram[i++] = 0x0A;                           // Memory location 0x0A
            _b.Ram[0x0A] = 14;
            _c.Tick(Opcodes.EOR.ZeroPage.Cycles);
        ...
        public void EOR_0x55_ZeroPage_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.EOR.ZeroPage_X.Opcode;    // EOR
            _b.Ram[i++] = 0x0A;                             // Memory location 0x0A
            _c.X = 2;
            _b.Ram[0x0C] = 14;
            _c.Tick(Opcodes.EOR.ZeroPage_X.Cycles);
        ...
        public void EOR_0x4D_Absolute()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.EOR.Absolute.Opcode;    // EOR
            ...
            _b.Ram[0x03E8] = 14;
            _c.Tick(Opcodes.EOR.Absolute.Cycles);
        ...
        public void EOR_0x5D_Absolute_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.EOR.Absolute_X.Opcode;    // EOR
        ...
        public void EOR_0x59_Absolute_Y()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.EOR.Absolute_Y.Opcode;    // EOR
        ...
        public void EOR_0x51_IndirectY()
        {
            _c.A = 5;
            byte i = 0;
            _b.Ram[i++] = Opcodes.EOR.IndirectIndexed.Opcode;   // Add Indirect_X
            ...
            _c.Tick(Opcodes.EOR.IndirectIndexed.Cycles);        // Tick


            Assert.Equal(5 ^ 14, _c.A);
            Assert.Equal(Opcodes.EOR.IndirectIndexed.Length, _c.PC); // Program counter should have moved to correct value
        }
