...
namespace FamiMan.Core.Tests
{
    public class ASL
    {
        ...
        public void ASL_0x1E_Absolute_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ASL.Absolute_X.Opcode;
            _b.Ram[i++] = 0x0E;
            _b.Ram[i++] = 0x00; // Memory location 0x000E = 14
        ...
        public void ASL_0x06_ZeroPage()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ASL.ZeroPage.Opcode;
        ...
        public void ASL_0x16_ZeroPage_X()
        {
            byte i = 0;
            _c.A = 0x05;
            _b.Ram[i++] = Opcodes.ASL.ZeroPage_X.Opcode;
            _b.Ram[i++] = 0x0E; // Memory location 0x000E = 14
            _c.X = 1;           // plux one = 15
            _b.Ram[0x0F] = 109; // 01101101
            _c.Tick(Opcodes.ASL.ZeroPage_X.Cycles);
        ...
        {
            byte i = 0;
            _b.Ram[i++] = Opcodes.ASL.Accumulator.Opcode;
            _c.A = 109;           // 01101101
            _c.Tick(Opcodes.ASL.Accumulator.Cycles);
